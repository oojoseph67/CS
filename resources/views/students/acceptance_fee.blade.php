    ...
    <div class="content">
        ...
        <div class="block block-rounded" >
            ...
            <div class="block-content center">
                ...
                <div class="content">
                    <!-- Modern Design -->
                    <h2 class="content-heading">Accepetance Fee</h2>
                    <div class="row center">
                        <div class="col-md-6 col-xl-3">
                            <!-- Freelancer Plan -->
                            <a class="block block-link-pop block-rounded text-center" href="javascript:void(0)">
                                <div class="block-header">
                                    <h3 class="block-title">Accepetance Fee</h3>
                                </div>
                                <div class="block-content bg-warning">
                                    <div class="py-2">
                                        <p class="h1 font-w700 text-white mb-2">#50000</p>
                                ...
                                <form method="POST" action="{{ route('pay') }}" accept-charset="UTF-8" class="form-horizontal" role="form">
                                    ...
                                    <input type="hidden" name="orderID" value="Acceptance Fee">
